...
@permission_required("home.add_student", raise_exception=True)
def add(request):
...
@permission_required("home.change_student", raise_exception=True)
...
@permission_required("home.delete_student", raise_exception=True)
